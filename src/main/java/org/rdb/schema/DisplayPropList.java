...
public class DisplayPropList {

	/*
	 * org.rdb.beans.Dependency org.rdb.beans.DependFieldMapping
	 * org.rdb.beans.DependProcedure org.rdb.beans.DependSourceTable
	 * org.rdb.beans.DependTargetTable org.rdb.beans.Field
	 * org.rdb.beans.MarkerObject org.rdb.beans.Partition
	 * org.rdb.beans.ProcDebug org.rdb.beans.Procedure org.rdb.beans.Sequence
	 * org.rdb.beans.Synonym org.rdb.beans.Table org.rdb.beans.TableSpace
	 * org.rdb.beans.TablespaceFile org.rdb.beans.User
	 */
	...
	public static void main(String[] args) {
		...
		try {
			for (String className : classNames) {
				...
				String sqlCreat;
				sqlCreat = "INSERT INTO " + tableName + "(";
				String fields = "";
				for (String str : columnNames) {
					fields += str.toUpperCase() + ", ";
				}
				String values = "";
				for (String str : columnNames) {
					values += "#{" + str + "}, ";
				...
				String updateValues = "@Update(\"UPDATE " + tableName + " SET ";
				for (String str : columnNames) {
					updateValues += str + " = #{" + str + "}, ";
				}

				sqlCreat += "@Insert(\"" + fields.substring(0, fields.length() - 2) + ") \n"
